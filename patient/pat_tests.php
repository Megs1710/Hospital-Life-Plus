...
<!DOCTYPE html>
<html lang="en">
<head><title>Life Plus_ Tests</title></head>
<body>
      ...
      <div class="row align-items-center">
        ...
        <div class="table-responsive">
            <?php
              ...
              $query = "SELECT distinct username,app_date from `alloted_test` where username='{$pat}'";
                ...
                if(mysqli_num_rows($data) > 0)
                {
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action = "display_tests.php" method = "post">
